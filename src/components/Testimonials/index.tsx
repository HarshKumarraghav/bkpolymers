...
const Testimonial = () => {
  ...
  return (
    <>
      <section className="dark:bg-dark pb-20 pt-20 lg:pb-[120px] lg:pt-[120px]">
        ...
        <div className="w-full items-center md:flex">
          ...
          <div className="w-full">
            <div>
              ...
              <p className="text-body-color dark:text-dark-6 mb-11 text-base font-normal italic leading-[1.81] sm:text-[22px]">
                {details}
              </p>

              <h4 className="text-dark mb-2 text-[22px] font-semibold leading-[27px] dark:text-white">
                {name}
              </h4>
